...
public sealed class MovimentacaoComercialTestes
{
    ...
    public void Deve_registrar_e_cancelar_movimentacao_com_rastreabilidade()
    {
        ...
        var movimentacao = MovimentacaoComercial.Registrar(Guid.NewGuid(), Guid.NewGuid(), "Ana", [CriarLinha(3, 29.90m)], agora, "ESS-123", "Balcao", OrigemDaMovimentacao.Recepcao, "operador-1", agora);
        ...
        Assert.Equal(89.70m, movimentacao.ValorTotal);
        Assert.Single(movimentacao.Linhas);
    }

...
function DefinicaoControlada() {
  ...
  return <DefinicaoPublico acaoId="6d3d0d64-a111-4cff-8db8-111111111111" criterios={criterios} simulacao={simulacao} aoSimular={setSimulacao} aoAlterarFiltros={() => setSimulacao(null)} />;
}

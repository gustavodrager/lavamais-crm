...
| `LAVAMAIS_ENVIO_NOTIFICACOES_HABILITADO` | sim | nao | apresenta ou bloqueia o envio individual na interface |
...
- a flag visual de envio deve acompanhar a flag da API, mas a API continua sendo a autoridade;

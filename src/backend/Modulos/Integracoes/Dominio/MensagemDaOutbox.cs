...
public sealed class MensagemDaOutbox
{
    ...
    public Guid Id { get; private set; } public Guid TenantId { get; private set; } public string Tipo { get; private set; } = ""; public string ChaveUnica { get; private set; } = ""; public string ConteudoJson { get; private set; } = "";
    public SituacaoDaOutbox Situacao { get; private set; } public int Tentativas { get; private set; } public DateTimeOffset DataCriacao { get; private set; } public DateTimeOffset DisponivelEm { get; private set; } public DateTimeOffset? ProcessandoAte { get; private set; } public DateTimeOffset? DataConclusao { get; private set; } public string? UltimoErro { get; private set; } public uint Versao { get; private set; }

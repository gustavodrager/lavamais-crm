...
public static class ExtensoesDoModuloClientes
{
    public static IServiceCollection AdicionarModuloClientes(this IServiceCollection servicos, IConfiguration configuracao)
    {
        ...
        servicos.AddScoped<GerenciadorDeClientes>(); servicos.AddScoped<ConsultaDeClientesParaSegmentacao>(); servicos.AddScoped<IConsultaDeClienteParaMovimentacao, ConsultaDeClienteParaMovimentacao>(); servicos.AddScoped<IConsultaDeClienteParaRoteiro, ConsultaDeClienteParaRoteiro>(); return servicos;
    }

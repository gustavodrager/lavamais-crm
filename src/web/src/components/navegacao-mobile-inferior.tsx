...
export function NavegacaoMobileInferior({ papel }: { papel?: SessaoApresentacao["papel"] }) {
  ...
  return <nav aria-label="Navegação rápida" className="fixed inset-x-0 bottom-0 z-30 grid grid-cols-4 border-t bg-card/95 pb-[env(safe-area-inset-bottom)] backdrop-blur md:hidden print:hidden">

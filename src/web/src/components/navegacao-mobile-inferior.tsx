...
import { Ellipsis, House, Megaphone, ReceiptText, Users } from "lucide-react";
...
export function NavegacaoMobileInferior({ papel }: { papel?: SessaoApresentacao["papel"] }) {
  ...
  const atalhosVisiveis = papel === "Operador" ? [atalhos[0], atalhos[2], { href: "/movimentacoes", rotulo: "Atender", icone: ReceiptText }] : atalhos;

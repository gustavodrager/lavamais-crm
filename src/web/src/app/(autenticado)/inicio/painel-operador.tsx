...
export function PainelOperador({ resumoAcoes, resumoMovimentacoes, roteiro, roteiroAmanha, dataHoje, dataAmanha }: PropriedadesPainelOperador) {
  ...
  return <>
    ...
    <div className="mt-5 grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
      <IndicadorTarefa href="/acoes-comerciais?filtro=ParaEnviar" icone={Send} titulo="Mensagens para enviar" valor={resumoAcoes.mensagensParaEnviar.toString()} detalhe="Fila de mensagens aprovadas" destaque={resumoAcoes.mensagensParaEnviar > 0} />

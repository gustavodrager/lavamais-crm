...
export function ExecucaoAcao({ acaoId, situacao, destinatarios }: { acaoId: string; situacao: SituacaoAcaoComercial; destinatarios: DestinatarioDaAcao[] }) {
  ...
  return <Card className="mt-6"><CardHeader><CardTitle>Destinatários e mensagens</CardTitle><CardDescription>Selecione um cliente, confira a mensagem congelada e confirme somente aquele envio.</CardDescription></CardHeader><CardContent className="space-y-5">

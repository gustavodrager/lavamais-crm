...
const rotulosResultado = { NaoInformado: "Não informado", SemRetorno: "Sem retorno", Respondeu: "Respondeu", Interessado: "Interessado", Convertido: "Convertido", NaoTemInteresse: "Sem interesse" };
...
export function ExecucaoAcao({ acaoId, versao, situacao, destinatarios }: { acaoId: string; versao: number; situacao: SituacaoAcaoComercial; destinatarios: DestinatarioDaAcao[] }) {
  const [mensagem, setMensagem] = useState<string | null>(null); const [pendente, iniciarTransicao] = useTransition();
